...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div v-if="product.deleted_at"
            ...
            This product has been deleted from the system, all records are for viewing only
        </div>
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <Accordion>
                        <template v-slot:title>
                            <span class="font-semibold text-lg my-2">Edit Product</span>
                        </template>
                        <template v-slot:content>
                            <section>
                                    ...
                                    <div class="flex justify-between">
                                        <span>
                                            <p class="mt-1 text-sm text-gray-600">
                                                View or edit products from the store.
                                            </p>
                                        </span>
                                        <span v-if="product.deleted_at" class="mt-1 text-gray-600">
                                ...
                                <form @submit.prevent="form.patch(route('products.update', product))" class="mt-6 space-y-6">
                                    <div>
                                        <InputLabel for="name" value="Product Name" />

                                        <TextInput id="name" type="text" class="mt-1 block w-full" v-model="form.name"
                                            required :disabled="product.deleted_at" autofocus />
                                    ...
                                    <div>
                                        ...
                                        <TextInput id="price" type="text" class="mt-1 block w-full"
                                            v-model="form.price" :disabled="product.deleted_at" required />
                                    ...
                                    <div class="flex items-center gap-4">
                                        <PrimaryButton v-if="!product.deleted_at" :disabled="form.processing">Update
                                        </PrimaryButton>
