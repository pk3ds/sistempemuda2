...
<template>
    ...
    <div v-if="$page.props.flash.success"
        class="bg-green-100 py-5 px-6 text-base text-green-700 inline-flex items-center w-full" role="alert">
    ...
    <div v-if="$page.props.flash.error"
        class="bg-red-100 py-5 px-6 text-base text-red-700 inline-flex items-center w-full" role="alert">
    ...
    <div v-if="$page.props.flash.warn"
        class="bg-yellow-100 py-5 px-6 text-base text-yellow-700 inline-flex items-center w-full" role="alert">
