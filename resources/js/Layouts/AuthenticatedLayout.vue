                        ...
                        <div class="flex">
                            ...
                            <div v-if="$page.props.auth.user && !$page.props.auth.can['view navs']"
                                ...
                                <a href="https://forms.office.com/pages/responsepage.aspx?id=WXQxFU5-2kWfKqqFhC-pLY29jou8FMZCuiOdBKczFitUMEgwSVpWTVozOVpVUFdHQ0kzU0tZRVRCTy4u"
                                    target="_blank"
                                    class="inline-flex items-center px-1 pt-1 border-b-4 border-transparent text-sm font-medium leading-5 text-white hover:text-gray-200 hover:border-white focus:outline-none focus:text-gray-200 focus:border-white transition duration-150 ease-in-out">
