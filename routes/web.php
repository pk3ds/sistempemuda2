...
Route::get('/lucky-draw/winners', [LuckyDrawController::class, 'index'])->name('draws.winners');

Route::middleware('auth', 'role:Admin|Committee')->group(function () {
    Route::get('/lucky-draw/single', [LuckyDrawController::class, 'createSingle'])->name('draws.createSingle');
    Route::post('/lucky-draw/single', [LuckyDrawController::class, 'storeSingle'])->name('draws.storeSingle');
    Route::get('/lucky-draw/multiple', [LuckyDrawController::class, 'createMultiple'])->name('draws.createMultiple');
    Route::post('/lucky-draw/multiple', [LuckyDrawController::class, 'storeMultiple'])->name('draws.storeMultiple');
});
...
Route::middleware('auth', 'role:Admin')->group(function () {
    ...
    Route::post('/contingents', [GroupController::class, 'store'])->name('groups.store');
    Route::get('/contingents/{group}/edit', [GroupController::class, 'edit'])->name('groups.edit');
    Route::patch('/contingents/{group}', [GroupController::class, 'update'])->name('groups.update');
    ...
    Route::patch('/awards/{award}', [AwardController::class, 'update'])->name('awards.update');
    Route::delete('/awards/{award}/delete', [AwardController::class, 'destroy'])->name('awards.destroy');
    ...
    Route::delete('/committees/{user}/delete', [CommitteeController::class, 'destroy'])->name('committees.destroy');
...
Route::middleware('auth')->group(function () {
    Route::get('/sessions/join/{meeting:uuid}/check-in', [CheckInController::class, 'create'])->name('checkins.create');
    Route::post('/sessions/join/{meeting:uuid}', [CheckInController::class, 'store'])->name('checkins.store');
    Route::get('/sessions/join/{meeting:uuid}/show/{checkIn}', [CheckInController::class, 'show'])->name('checkins.show');
    Route::post('/sessions/join/{meeting:uuid}/calculate', [CheckInController::class, 'calculate'])->name('checkins.calculate');
});
